...
class AIRewritingGuidanceScreen extends StatefulWidget {
  const AIRewritingGuidanceScreen({Key? key}) : super(key: key);

  @override
  State<AIRewritingGuidanceScreen> createState() =>
      _AIRewritingGuidanceScreenState();
}

class _AIRewritingGuidanceScreenState extends State<AIRewritingGuidanceScreen> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // How to use AI Rewriting section
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'AI Rewriting uses artificial intelligence to improve your text by making it more clear, engaging, and professional. To use it, select the text you want to rewrite, tap the AI Rewriting button, choose your preferred writing style, and review the suggestions before accepting.',
