...
class SettingsManager {
    ...
    func loadAllSettings() -> KeyboardSettings {
        return KeyboardSettings(
            ...
            shiftFeedbackEnabled: shiftFeedbackEnabled,
    ...
    func save(settings: KeyboardSettings) {
        ...
        keyPreviewEnabled = settings.keyPreviewEnabled
        ...
        shiftFeedbackEnabled = settings.shiftFeedbackEnabled
...
// MARK: - Keyboard Settings Value Object
